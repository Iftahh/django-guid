...
class ASGIGuidMiddleware(object):
    """
    ...
    def __call__(self, request: HttpRequest) -> Union[HttpRequest, HttpResponse]:
        ...
        # print('Guid from middleware is: ', self.get_guid())
    ...
    def get_guid(cls, default: str = None) -> str:
        ...
        """
        return getattr(cls._local, 'guid', default)
